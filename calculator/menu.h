...
private:
	vector<double> Data;
	map <int, string> Errors = { {1,"n = 0"},{2,"Число испытаний мало для формулы Пуассона"},{3,"Вероятность велика для Пуассона"},{4,"число должно быть целое"},{5,"n > 15"},{6,"Сигма < 0"},{10,"В распределении присутствуют одинаковые X-ы"},{11,"Нехватка аргументов"},{12,"Число должно быть больше 0"},{13,"Сумма вероятностей не равна 1"},{14,"m > n"} };
public:
	vector<double> start();
